...
export function CardPedidoCozinha({
  ...
  const urlWhatsappCliente = montarUrlWhatsapp(pedido.dados_cliente?.telefone);
    ...
    <div className="flex flex-col justify-between rounded-2xl border border-zinc-200 bg-white p-4 text-[#1A1A1A] shadow-sm select-none">
      <div>
        ...
        {pedido.status === 'PENDENTE' && (
          <div
            role="alert"
            className="mb-3 flex items-center gap-1.5 rounded-lg border border-amber-300 bg-amber-50 px-2.5 py-1.5 text-[11px] font-bold uppercase tracking-wide text-amber-800"
          >
        ...
        <div className="mb-3 border-b border-zinc-100 pb-2">
          ...
          <div className="mt-0.5 flex items-center justify-between gap-2">
            <p className="text-sm font-bold text-zinc-700">{pedido.dados_cliente?.telefone}</p>
            {urlWhatsappCliente && (
              <a
                ...
                className="inline-flex min-h-[40px] shrink-0 items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 px-3.5 py-2 text-xs font-bold text-emerald-700 transition hover:bg-emerald-100 active:bg-emerald-100"
              >
