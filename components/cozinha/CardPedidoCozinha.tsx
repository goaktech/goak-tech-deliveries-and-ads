          ...
          <div className="mt-0.5 flex items-center justify-between gap-2">
            ...
            {urlWhatsappCliente && (
              <a
                ...
                className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-emerald-200 bg-emerald-50 text-emerald-700 transition hover:bg-emerald-100 active:bg-emerald-100"
              >
